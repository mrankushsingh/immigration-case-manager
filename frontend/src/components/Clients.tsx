  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="flex justify-between items-center border-b border-gray-200 pb-6">
        <div>
          <h2 className="text-4xl font-bold text-slate-900 mb-2 tracking-tight">Clients</h2>
          <p className="text-slate-600 text-lg">Manage your immigration clients and cases</p>
        </div>
        <button
      ...
      {clients.length === 0 ? (
        <div className="bg-white rounded-2xl professional-shadow-lg border border-gray-100 p-16 text-center animate-scale-in">
          ...
          <p className="text-slate-500 mb-8 text-lg">Create your first client to get started</p>
          <button
            onClick={() => setShowCreateModal(true)}
